<?php $__env->startSection('title', 'Calibrações - CalibSys'); ?>

<?php $__env->startSection('page-title', 'Calibrações'); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.button','data' => ['variant' => 'primary','icon' => 'fas fa-plus','href' => route('calibracoes.create')]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['variant' => 'primary','icon' => 'fas fa-plus','href' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(route('calibracoes.create'))]); ?>
            Nova Calibração
    ...
    <div class="rounded-2xl border border-gray-200 dark:border-gray-800 bg-white dark:bg-white/[0.03] p-6 shadow-sm">
        <div class="flex items-center justify-between">
            <div>
                ...
                <p class="text-3xl font-bold text-gray-900 dark:text-white mt-2"><?php echo e($calibracoes->count()); ?></p>
            </div>
        ...
        <div class="flex items-center justify-between">
            <div>
                ...
                <p class="text-3xl font-bold text-green-600 dark:text-green-400 mt-2">
                    <?php echo e($calibracoes->filter(function($c) {
    ...
    <div class="rounded-2xl border border-gray-200 dark:border-gray-800 bg-white dark:bg-white/[0.03] p-6 shadow-sm">
        <div class="flex items-center justify-between">
            <div>
                ...
                <p class="text-3xl font-bold text-green-600 dark:text-green-400 mt-2">
                    <?php echo e($calibracoes->where('resultado', 'aprovado')->count()); ?>
        ...
        <div class="flex items-center justify-between">
            <div>
                ...
                <p class="text-3xl font-bold text-red-600 dark:text-red-400 mt-2">
                    <?php echo e($calibracoes->where('resultado', 'reprovado')->count()); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.datatable3','data' => ['id' => 'calibracoesTable','title' => '','headers' => ['ID', 'Equipamento', 'Laboratório', 'Data Calibração', 'Certificado', 'Resultado', 'Ações'],'searchable' => true,'exportable' => true]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['id' => 'calibracoesTable','title' => '','headers' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(['ID', 'Equipamento', 'Laboratório', 'Data Calibração', 'Certificado', 'Resultado', 'Ações']),'searchable' => true,'exportable' => true]); ?>
                ...
                <?php $__empty_1 = true; $__currentLoopData = $calibracoes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $calibracao): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <tr class="hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors">
                        <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900 dark:text-white">
                            #<?php echo e($calibracao->id); ?>

                        </td>
                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-700 dark:text-gray-300">
                            <?php echo e($calibracao->equipamento->equipamento_tipo ?? 'N/A'); ?>

                            <br>
                            <span class="text-xs text-gray-500"><?php echo e($calibracao->equipamento->equipamento_codigo_interno ?? '-'); ?></span>
                        </td>
                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-700 dark:text-gray-300">
                            <?php echo e($calibracao->laboratorio->nome ?? 'N/A'); ?>

                        </td>
                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-700 dark:text-gray-300">
                            <?php echo e($calibracao->data_calibracao ? \Carbon\Carbon::parse($calibracao->data_calibracao)->format('d/m/Y') : '-'); ?>

                        </td>
                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-700 dark:text-gray-300">
                            <?php echo e($calibracao->certificado_num ?? '-'); ?>
...
<?php endif; ?>
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                            <div class="flex items-center justify-end gap-2">
                                <a href="<?php echo e(route('calibracoes.show', $calibracao->id)); ?>"
                                   class="text-blue-600 hover:text-blue-900 dark:text-blue-400 dark:hover:text-blue-300"
                                   title="Visualizar">
                                    <i class="fas fa-eye"></i>
                                </a>
                                <a href="<?php echo e(route('calibracoes.edit', $calibracao->id)); ?>"
                                   class="text-yellow-600 hover:text-yellow-900 dark:text-yellow-400 dark:hover:text-yellow-300"
                                   title="Editar">
                                    <i class="fas fa-edit"></i>
                                </a>
                                <form action="<?php echo e(route('calibracoes.destroy', $calibracao->id)); ?>"
                                      method="POST"
                                      class="inline-block"
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/luciano/Área de trabalho/dev/calibracao_V0/resources/views/calibracoes/index.blade.php ENDPATH**/ ?>