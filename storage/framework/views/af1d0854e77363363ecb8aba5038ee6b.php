...
<div class="rounded-2xl border border-gray-200 bg-white dark:border-gray-800 dark:bg-white/[0.03] mb-6">
    ...
    <div class="p-5 sm:p-6">
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-4">
            ...
            <div x-data="multiSelect('setor', <?php echo e(json_encode($setores)); ?>)" class="relative">
                <label class="mb-1.5 block text-sm font-medium text-gray-700 dark:text-gray-400">
                    Setor
                </label>
                <div class="relative">
            ...
            <div x-data="multiSelect('tipo', <?php echo e(json_encode($tiposOrdenados)); ?>)" class="relative">
                <label class="mb-1.5 block text-sm font-medium text-gray-700 dark:text-gray-400">
                    Tipo Equipamento
                </label>
                <div class="relative">
            ...
            <div x-data="multiSelect('status', <?php echo e(json_encode($statusCalibracao)); ?>)" class="relative">
                <label class="mb-1.5 block text-sm font-medium text-gray-700 dark:text-gray-400">
                    Status Calibração
                </label>
                <div class="relative">
        ...
        <div class="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
            <div>
                ...
                <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">
                    <span id="filteredCount"><?php echo e($equipamentos->count()); ?></span> equipamentos encontrados
                </p>
            </div>
                ...
                <tbody class="divide-y divide-gray-100 dark:divide-gray-800">
                    <?php $__empty_1 = true; $__currentLoopData = $equipamentos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $equipamento): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        ...
                        <tr class="hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors"
                            data-setor="<?php echo e($equipamento->equipamento_setor ?? ''); ?>"
                            data-tipo="<?php echo e($equipamento->equipamento_tipo ?? ''); ?>"
                            data-status="<?php echo e($equipamento->equipamento_certificado_status ?? ''); ?>"
                            data-dias="<?php echo e($diasParaVencer); ?>">
                            <!-- Setor -->
                            ...
                            <td class="px-4 py-3">
                                <div class="flex flex-col">
                                    <span class="text-sm font-medium text-gray-900 dark:text-white">
                                        <?php echo e(\Illuminate\Support\Str::limit($equipamento->equipamento_tipo ?? '-', 40)); ?>

                                    </span>
                                    <span class="text-xs text-gray-500 dark:text-gray-400">
                                        <i class="fas fa-barcode mr-1"></i><?php echo e($equipamento->equipamento_codigo_interno ?? '-'); ?>
                            ...
                            <td class="px-4 py-3">
                                <div class="flex flex-col">
                                    ...
                                    <span class="text-xs text-gray-500 dark:text-gray-400">
                                        <?php echo e(\Illuminate\Support\Str::limit($equipamento->equipamento_modelo ?? '-', 30)); ?>
                            ...
                            <td class="px-4 py-3">
                                ...
                                <?php elseif($equipamento->equipamento_certificado_status === 'EM CALIBRAÇÃO'): ?>
                                ...
                                <?php else: ?>
                                    <span class="inline-flex items-center text-gray-400 text-xs">
                                        <i class="fas fa-minus-circle mr-1"></i><?php echo e($equipamento->equipamento_certificado_status ?? '-'); ?>
                            ...
                            <!-- Próxima Calibração -->
                            <td class="px-4 py-3 text-sm" data-order="<?php echo e($proximaData ? $proximaData->format('Y-m-d') : '9999-12-31'); ?>">
                                <?php if($proximaData): ?>
                                    <?php if($vencida): ?>
                                        <span class="inline-flex items-center rounded-full bg-red-100 px-2.5 py-0.5 text-xs font-medium text-red-800 dark:bg-red-900/50 dark:text-red-400">
                                            <i class="fas fa-exclamation-triangle mr-1"></i><?php echo e($proximaData->format('d/m/Y')); ?>

                                        </span>
                                    <?php elseif($aVencer30): ?>
                                        <span class="inline-flex items-center rounded-full bg-yellow-100 px-2.5 py-0.5 text-xs font-medium text-yellow-800 dark:bg-yellow-900/50 dark:text-yellow-400">
                                            <i class="fas fa-clock mr-1"></i><?php echo e($proximaData->format('d/m/Y')); ?>

                                        </span>
                                    <?php else: ?>
                                        <span class="text-gray-700 dark:text-gray-300"><?php echo e($proximaData->format('d/m/Y')); ?></span>
                                    <?php endif; ?>
                                <?php else: ?>
