...
<div class="container mx-auto px-4 py-8">
    <div class="max-w-3xl mx-auto">
        ...
        <form action="{{ route('laboratorios.update', $laboratorio) }}" method="POST" class="bg-white shadow-md rounded px-8 pt-6 pb-8">
            @csrf
            @method('PUT')
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="col-span-2">
                    <label class="flex items-center">
                        <input 
                            ...
                            id="acreditado" 
                            value="1"
                            {{ old('acreditado', $laboratorio->acreditado) ? 'checked' : '' }}
                ...
                <div class="col-span-2">
                    ...
                    >{{ old('escopo', $laboratorio->escopo) }}</textarea>
                </div>
            </div>
