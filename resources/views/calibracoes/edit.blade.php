    ...
    <div class="container mx-auto px-4 py-8">
        <div class="max-w-3xl mx-auto">
            <div class="flex justify-between items-center mb-6">
                <h1 class="text-3xl font-bold text-gray-800">Editar Calibração</h1>
            ...
            <form action="{{ route('calibracoes.update', $calibracao) }}" method="POST" enctype="multipart/form-data"
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div class="col-span-2">
                        ...
                        <select name="equipamento_id" id="equipamento_id"
                            ...
                            @foreach($equipamentos as $equipamento)
                                <option value="{{ $equipamento->id }}" {{ old('equipamento_id', $calibracao->equipamento_id) == $equipamento->id ? 'selected' : '' }}>
                    ...
                    <div>
                        ...
                        <input type="date" name="data_calibracao" id="data_calibracao"
                            value="{{ old('data_calibracao', $calibracao->data_calibracao) }}"
                    ...
                    <div>
                        ...
                        <input type="date" name="data_validade" id="data_validade"
                            value="{{ old('data_validade', $calibracao->data_validade) }}"
                    ...
                    <div>
                        ...
                        <input type="text" name="certificado_num" id="certificado_num"
                            value="{{ old('certificado_num', $calibracao->certificado_num) }}"
                    ...
                    <div>
                        ...
                        <select name="resultado" id="resultado"
                            ...
                            <option value="aprovado" {{ old('resultado', $calibracao->resultado) == 'aprovado' ? 'selected' : '' }}>Aprovado</option>
                            <option value="reprovado" {{ old('resultado', $calibracao->resultado) == 'reprovado' ? 'selected' : '' }}>Reprovado</option>
                            <option value="condicional" {{ old('resultado', $calibracao->resultado) == 'condicional' ? 'selected' : '' }}>Condicional</option>
                        </select>
                    </div>
                    ...
                    <div class="col-span-2">
                        ...
                        <input type="text" name="laboratorio_nome" id="laboratorio_nome"
                            value="{{ old('laboratorio_nome', $calibracao->laboratorio_nome) }}"
                            class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline">
                    </div>
                    ...
                    <div class="col-span-2">
                        ...
                        <textarea name="observacoes" id="observacoes" rows="4"
                            class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline">{{ old('observacoes', $calibracao->observacoes) }}</textarea>
                    </div>
