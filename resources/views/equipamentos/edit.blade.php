...
@section('title', 'Editar Equipamento - Sistema de Calibração')
...
<form action="{{ route('equipamentos.update', $equipamento->id) }}" method="POST" enctype="multipart/form-data" class="space-y-6">
    @csrf
    @method('PUT')
    ...
    <div class="rounded-lg bg-white dark:bg-gray-800 shadow-md p-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            <x-input
                ...
                :value="old('equipamento_classe', $equipamento->equipamento_classe ?? '')"
            ...
            <x-input
                ...
                :value="old('equipamento_tipo', $equipamento->equipamento_tipo ?? '')"
            ...
            <x-input
                ...
                :value="old('equipamento_codigo_interno', $equipamento->equipamento_codigo_interno ?? '')"
            ...
            <x-input
                ...
                :value="old('equipamento_fabricante', $equipamento->equipamento_fabricante ?? '')"
            ...
            <x-input
                ...
                :value="old('equipamento_modelo', $equipamento->equipamento_modelo ?? '')"
            ...
            <x-input
                ...
                :value="old('equipamento_serial', $equipamento->equipamento_serial ?? '')"
    ...
    <div class="rounded-lg bg-white dark:bg-gray-800 shadow-md p-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            <x-input
                ...
                :value="old('equipamento_resolucao', $equipamento->equipamento_resolucao ?? '')"
            ...
            <x-input
                ...
                :value="old('equipamento_faixa_medicao', $equipamento->equipamento_faixa_medicao ?? '')"
            ...
            <x-input
                ...
                :value="old('equipamento_incerteza_nominal', $equipamento->equipamento_incerteza_nominal ?? '')"
    ...
    <div class="rounded-lg bg-white dark:bg-gray-800 shadow-md p-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-4">
            <x-input
                ...
                placeholder="Ex: 200"
                :value="old('equipamento_altura_mm', $equipamento->equipamento_altura_mm ?? '')"
            ...
            <x-input
                ...
                placeholder="Ex: 100"
                :value="old('equipamento_largura_mm', $equipamento->equipamento_largura_mm ?? '')"
            ...
            <x-input
                ...
                placeholder="Ex: 300"
                :value="old('equipamento_comprimento_mm', $equipamento->equipamento_comprimento_mm ?? '')"
            ...
            <x-input
                ...
                placeholder="Ex: 110"
                :value="old('equipamento_tensao_v', $equipamento->equipamento_tensao_v ?? '')"
            ...
            <x-input
                ...
                placeholder="Ex: 60"
                :value="old('equipamento_potencia_w', $equipamento->equipamento_potencia_w ?? '')"
    ...
    <div class="rounded-lg bg-white dark:bg-gray-800 shadow-md p-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            <x-input
                ...
                :value="old('equipamento_data_ultima_calibracao', $equipamento->equipamento_data_ultima_calibracao ?? '')"
            ...
            <x-input
                ...
                :value="old('equipamento_data_proxima_calibracao', $equipamento->equipamento_data_proxima_calibracao ?? '')"
            ...
            <x-input
                ...
                placeholder="Ex: 12"
                :value="old('equipamento_periodicidade_meses', $equipamento->equipamento_periodicidade_meses ?? '')"
            ...
            <x-input
                ...
                :value="old('equipamento_local_calibracao', $equipamento->equipamento_local_calibracao ?? '')"
    ...
    <div class="rounded-lg bg-white dark:bg-gray-800 shadow-md p-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <x-input
                ...
                :value="old('equipamento_localizacao', $equipamento->equipamento_localizacao ?? '')"
            ...
            <x-input
                ...
                :value="old('equipamento_setor', $equipamento->equipamento_setor ?? '')"
    ...
    <div class="rounded-lg bg-white dark:bg-gray-800 shadow-md p-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            <x-select
                ...
                :selected="old('equipamento_frequencia_uso', $equipamento->equipamento_frequencia_uso ?? '')"
            ...
            <x-select
                ...
                :selected="old('equipamento_necessidade_critica', $equipamento->equipamento_necessidade_critica ?? '')"
            ...
            <x-select
                ...
                :selected="old('equipamento_abundancia', $equipamento->equipamento_abundancia ?? '')"
            ...
            <x-select
                ...
                :selected="old('equipamento_custo_indisponibilidade', $equipamento->equipamento_custo_indisponibilidade ?? '')"
            ...
            <x-select
                ...
                :selected="old('equipamento_criticidade_metrologica', $equipamento->equipamento_criticidade_metrologica ?? '')"
    ...
    <div class="rounded-lg bg-white dark:bg-gray-800 shadow-md p-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
            <x-input
                ...
                :value="old('valor_aquisicao', $equipamento->valor_aquisicao ?? '')"
            ...
            <x-input
                ...
                :value="old('equipamento_custo_estimado', $equipamento->equipamento_custo_estimado ?? '')"
            ...
            <x-input
                ...
                name="data_aquisicao"
                :value="old('data_aquisicao', $equipamento->data_aquisicao ?? '')"
    ...
    <div class="rounded-lg bg-white dark:bg-gray-800 shadow-md p-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
            <x-input
                ...
                type="url"
                placeholder="https://..."
                :value="old('equipamento_link_fabricante', $equipamento->equipamento_link_fabricante ?? '')"
        ...
        <div class="grid grid-cols-1 gap-4">
            <x-textarea
                ...
                :value="old('equipamento_instrucao_uso', $equipamento->equipamento_instrucao_uso ?? '')"
            ...
            <x-textarea
                ...
                :value="old('equipamento_instrucao_operacao', $equipamento->equipamento_instrucao_operacao ?? '')"
            ...
            <x-textarea
                ...
                :value="old('equipamento_instrucao_seguranca', $equipamento->equipamento_instrucao_seguranca ?? '')"
            ...
            <x-textarea
                ...
                :value="old('equipamento_comentarios', $equipamento->equipamento_comentarios ?? '')"
