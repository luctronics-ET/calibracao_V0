...
@section('title', 'Editar Lote #' . $lote->id . ' - CalibSys')
    ...
    <x-card title="Informações do Lote" icon="fas fa-info-circle">
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <x-select
                ...
                :selected="old('status', $lote->status ?? 'preparacao')"
            />
            ...
            <x-input
                ...
                :value="old('responsavel_envio', $lote->responsavel_envio ?? '')"
            ...
            <x-input
                ...
                :value="old('transportadora', $lote->transportadora ?? '')"
        ...
        <div class="mt-6">
            <x-textarea
                name="observacoes"
                label="Observações"
                :value="old('observacoes', $lote->observacoes ?? '')"
